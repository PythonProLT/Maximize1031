              ...
              <div className="mb-6 flex md:mb-0 md:w-1/2">
                ...
                <div className="rounded-lg bg-white p-6 shadow-md md:mr-8">
                  ...
                  <p className="text-gray-600">
                    Contact us before listing your property. We'll discuss your exchange strategy and prepare the
            ...
            <div className="md:flex md:items-center">
              ...
              <div className="mb-6 flex md:mb-0 md:w-1/2">
                ...
                <div className="rounded-lg bg-white p-6 shadow-md md:ml-8">
                  ...
                  <p className="text-gray-600">
                    Within 45 days, you identify potential replacement properties. We provide the proper identification
                    forms.
                  </p>
                </div>
              </div>
